...
public class FinishedProductService {
    ...
    @Transactional
    public void save(FinishedProduct product, MultipartFile imageFile) throws IOException {
    ...
    @Transactional
    public void update(FinishedProduct product, MultipartFile imageFile) throws IOException {
    ...
    // FinishedProductService.java - добавить этот метод
    @Transactional
